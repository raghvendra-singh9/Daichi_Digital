...
import React from 'react';
import Image from 'next/image';
import serviceData from '@/components/containers/service-details/data/serviceData.json'; // Adjust the path based on your project structure
...
const ServiceDetailsMain: React.FC<ServiceDetailsMainProps> = ({ data }) => {
  return (
    <section className="section service-details fade-wrapper">
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-12 col-xl-10">
            <div className="service-details__slider">
              <div className="service-details__slider-single">
                ...
                <div className="details-group section__cta text-start">
                  <h3 className="title-anim">{data.title}</h3>
                ...
                <div className="section__content-cta">
                  <div className="row gaper">
                    <div className="col-12 col-lg-7">
                      <div className="details-group">
                        <h3 className="title-anim">{data.approachTitle}</h3>
                        {data.approachContent.map((para, index) => (
                          <p key={index}>{para}</p>
                        ))}
                      </div>
                    </div>
